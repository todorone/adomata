...
export const fleetBoardQueries = {
	...
	// A video-only creative whose file couldn't be streamed falls back to Meta's own hosted
	// preview iframe — fetched only then, since it costs a live Meta API call.
